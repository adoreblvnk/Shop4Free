...
gulp.task("copy", function () {
  ...
  gulp
    .src(["bower_components/datatables/media/**/*"])
    .pipe(gulp.dest("vendor/datatables"));

  gulp
    .src(["bower_components/datatables-plugins/integration/bootstrap/3/*"])
    .pipe(gulp.dest("vendor/datatables-plugins"));

  gulp
    .src([
      "bower_components/datatables-responsive/css/*",
      "bower_components/datatables-responsive/js/*",
    ])
    .pipe(gulp.dest("vendor/datatables-responsive"));

  gulp.src(["bower_components/flot/*.js"]).pipe(gulp.dest("vendor/flot"));
  ...
  gulp
    .src(["bower_components/metisMenu/dist/*"])
    .pipe(gulp.dest("vendor/metisMenu"));

  gulp
    .src([
      "bower_components/morrisjs/*.js",
